...
const logoData = fs.readFileSync("src/assets/ramplix-wordmark.png").toString("base64");
const imgH = 11, imgW = imgH * (422/110);
doc.addImage("data:image/png;base64,"+logoData, "PNG", CENTER-imgW/2, logoY-8, imgW, imgH);
...
fs.writeFileSync("/tmp/final_test.pdf", Buffer.from(doc.output("arraybuffer")));
console.log("done");
